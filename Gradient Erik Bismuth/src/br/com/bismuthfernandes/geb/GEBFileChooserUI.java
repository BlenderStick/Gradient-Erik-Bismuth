...
/**
 * Esta é uma cópia do MetalFileChooser com algumas adaptações para sincronizar com a GEBLookAndFeel
 * 
 * Metal L&amp;F implementation of a FileChooser.
 *
 * @author Jeff Dinkins
 */
public class GEBFileChooserUI extends BasicFileChooserUI {
...
//    private static final Dimension hstrut11 = new Dimension(11, 1);
    ...
    public static ComponentUI createUI(JComponent c) {
        return new GEBFileChooserUI((JFileChooser) c);
    }

    public GEBFileChooserUI(JFileChooser filechooser) {
        super(filechooser);
    }

    public void installUI(JComponent c) {
        super.installUI(c);
//        ((JFileChooser) c).setFileView(new FileView());
    }
    ...
    private class MetalFileChooserUIAccessor implements FilePane.FileChooserUIAccessor {
        public JFileChooser getFileChooser() {
            return GEBFileChooserUI.this.getFileChooser();
        }

        public BasicDirectoryModel getModel() {
            return GEBFileChooserUI.this.getModel();
        }

        public JPanel createList() {
            return GEBFileChooserUI.this.createList(getFileChooser());
        }

        public JPanel createDetailsView() {
            return GEBFileChooserUI.this.createDetailsView(getFileChooser());
        }

        public boolean isDirectorySelected() {
            return GEBFileChooserUI.this.isDirectorySelected();
        }

        public File getDirectory() {
            return GEBFileChooserUI.this.getDirectory();
        }

        public Action getChangeToParentDirectoryAction() {
            return GEBFileChooserUI.this.getChangeToParentDirectoryAction();
        }

        public Action getApproveSelectionAction() {
            return GEBFileChooserUI.this.getApproveSelectionAction();
        }

        public Action getNewFolderAction() {
            return GEBFileChooserUI.this.getNewFolderAction();
        }

		@SuppressWarnings("rawtypes")
		public MouseListener createDoubleClickListener(JList list) {
            return GEBFileChooserUI.this.createDoubleClickListener(getFileChooser(),
                                                                     list);
        }

        public ListSelectionListener createListSelectionListener() {
            return GEBFileChooserUI.this.createListSelectionListener(getFileChooser());
        }
    }
    ...
    class DirectoryComboBoxRenderer extends DefaultListCellRenderer  {
        ...
        public Component getListCellRendererComponent(JList<?> list, Object value,
            ...
            Icon icon = GEBIcons.getFileViewComputer();//getFileChooser().getIcon(directory);
//            System.out.println((icon == null) + " Diretório = "+directory.getAbsolutePath());
//            System.out.println("Diretório = "+directory.isDirectory());
//            System.out.println("Absolute = "+directory.isAbsolute());
//            System.out.println("File = "+directory.isFile());
//            System.out.println("Hidden = "+directory.isHidden());
//            Icon icone = UIManager.getIcon("FileView.directoryIcon");
//            System.out.println("New Icon == null? "+(icone == null));
            ii.icon = icon;

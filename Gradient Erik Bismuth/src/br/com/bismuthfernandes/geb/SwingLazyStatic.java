 ...
 *
 */
public class SwingLazyStatic implements UIDefaults.LazyValue {
    private String className;
    private String methodName;
    private Object[] args;

    public SwingLazyStatic(String c, String m) {
        this(c, m, null);
    }
    public SwingLazyStatic(String c, Object[] o) {
        this(c, null, o);
    }
    public SwingLazyStatic(String c, String m, Object[] o) {
        className = c;
        methodName = m;
        if (o != null) {
            args = (Object[])o.clone();
